            ...
            <div className='container mx-auto px-6 lg:px-10 py-1'> {/* Added padding inside container */}
                <div className='flex flex-wrap p-3 flex-col md:flex-row items-center'>
                    ...
                    <nav className='md:ml-auto flex flex-wrap items-center text-base justify-center'>
                        <Link className='text-white mr-5 cursor-pointer hover:text-gray-200 flex items-center' href={'/cart'}>
                            Cart
                            <svg
                            ...
                            (
                                <>
                                    {localStorage.getItem('isAdmin') === "true" ?
                                        ...
                                        <Link className='text-white mr-5 cursor-pointer hover:text-gray-200 flex items-center' href={'/admin'}>
                                            Admin
                                            <svg
                                                xmlns="http://www.w3.org/2000/svg"
                                                fill="none"
