...
const Cart = () => {
  ...
  return (
    <div style={{ minHeight: "95vh" }} className='flex items-center overflow-x-hidden'>
                ...
                state.length > 0 ?
                  (
                    <>
                      ...
                      <button onClick={handleCheckOut} className='border text-gray-900 dark:text-gray-100 font-bold dark:border-gray-400 border-gray-900 rounded mr-2 p-2 bg-gradient-to-r from-indigo-700 via-violet-700 to-orange-700 hover:text-gray-100'>checkout</button>
                    </>
                  )
                  :
                  (
